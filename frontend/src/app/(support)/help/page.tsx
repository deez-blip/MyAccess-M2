            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-white/95 backdrop-blur-sm border-slate-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                <CardContent className="pt-8 text-center">
                  <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[#e5edff] text-primary" aria-hidden="true">
                    <Search className="h-7 w-7" />
                  </div>
                  <h3 className="mb-2 text-lg font-bold text-[#14284b]">Recherche</h3>
              ...
              <Card className="bg-white/95 backdrop-blur-sm border-slate-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                <CardContent className="pt-8 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-bold text-[#14284b]">Rendez-vous</h3>
                  <p className="text-sm font-medium text-[#556987]">
              ...
              <Card className="bg-white/95 backdrop-blur-sm border-slate-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                <CardContent className="pt-8 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-bold text-[#14284b]">Notation</h3>
                  <p className="text-sm font-medium text-[#556987]">
            ...
            <Card className="bg-white/95 backdrop-blur-sm border-slate-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
              ...
              <CardContent className="pt-6">
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-1" className="border-slate-100">
                    ...
                    <AccordionContent className="text-[#556987] font-medium leading-relaxed pt-2">
                      ...
                      <ul className="list-disc list-inside mt-3 space-y-2 ml-2">
                        <li><strong className="text-[#14284b]">Accessibilité physique</strong> : rampes, ascenseurs, parking PMR, toilettes adaptées</li>
                        <li><strong className="text-[#14284b]">Accessibilité numérique</strong> : site web accessible, prise de RDV en ligne</li>
                        <li><strong className="text-[#14284b]">Qualité de l'accueil</strong> : personnel formé, langue des signes, patience</li>
                      </ul>
                      <p className="mt-4">
                  ...
                  <AccordionItem value="item-7" className="border-slate-100 border-b-0">
                    <AccordionTrigger className="text-[#14284b] hover:text-primary font-bold text-base data-[state=open]:text-primary transition-colors">
          ...
          <section aria-labelledby="contact-title">
            <Card className="bg-primary text-white shadow-xl shadow-primary/10 border-transparent relative overflow-hidden">
              ...
              <CardHeader className="relative z-10">
                <CardTitle id="contact-title" className="flex items-center gap-3 text-white">
              ...
              <CardContent className="relative z-10 text-white/90">
                ...
                <div className="space-y-3 font-medium bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                  <p className="flex items-center flex-wrap gap-2">
                    ...
                    <a href="mailto:support@accessisante.fr" className="text-white font-bold hover:underline focus:outline-none focus:ring-2 focus:ring-white/50 rounded px-1 transition-all">
                      support@accessisante.fr
                    </a>
                  </p>
                  <p className="flex items-center flex-wrap gap-2">
                    <span className="text-white font-bold">Téléphone :</span>
                    <a href="tel:+33123456789" className="text-white font-bold hover:underline focus:outline-none focus:ring-2 focus:ring-white/50 rounded px-1 transition-all">
                      01 23 45 67 89
                    </a>
                    <span className=" text-sm ml-2">(Lun-Ven 9h-18h)</span>
                  </p>
                  <p className="flex items-center gap-2 mt-4 pt-4 border-t border-white/20">
                    <span className="text-white font-bold">Temps de réponse :</span> 
